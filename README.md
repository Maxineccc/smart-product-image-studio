...
当前版本 v3.2.0：参考用户提供的奶茶日常、清爽果茶、黑金马斯卡彭与户外街景广告新增四套模板。全部使用项目内透明淘宝闪购 Logo；黑金新品模板不再展示“20元优惠券”，改为大字号突出当前到手价“¥0.01起”。

模板按 800×800 方形和 1280×720 横版分组，共十八套，可全选、取消全选或单独勾选；ZIP 只生成已选模板。全部模板统一使用用户提供的淘宝闪购透明 Logo，并绘制用户选择的警示语；警示语默认位于底部，可调整左右与上下位置。
