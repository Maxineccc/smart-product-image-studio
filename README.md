...
当前版本 v2.2.1：全部模板统一使用用户提供的淘宝闪购透明 Logo，并扩展为 3 套 800×800 方形模板和 3 套 1280×720 横版模板。同一张商品主体只需上传一次，即可逐套预览或一键打包下载六套 JPG 模板。结算单模板缩小了主体默认尺寸，并为纯色底抠图增加两层边缘去色溢处理，清除商品外沿残留描边。
