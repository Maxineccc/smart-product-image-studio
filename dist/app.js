...
const placementDefault={scale:100,x:0,y:0,rotation:0,opacity:100,flip:false,shadow:true};
function getPlacement(key=state.template){return state.placements[key]||(state.placements[key]={...placementDefault})}
...
const templateFileLabels={square:'结算单',socialCoupon:'红包券卡',socialMinimal:'留白单品',socialDeal:'左右好价',socialDuo:'双杯下单',socialScene:'场景种草',squareBestseller:'爆款咖啡',cafe:'咖啡场景',landscapeClean:'简洁好价',landscapeDark:'质感上新'},sequenceFallback=new Map();
